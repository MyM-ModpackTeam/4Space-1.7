package mattparks.mods.space.callisto.dimension;

import mattparks.mods.space.callisto.CallistoCore;
import mattparks.mods.space.callisto.util.ConfigManagerCallisto;
import mattparks.mods.space.callisto.world.gen.ChunkProviderCallisto;
import mattparks.mods.space.callisto.world.gen.WorldChunkManagerCallisto;
...
public class WorldProviderCallisto extends WorldProviderSpace implements IGalacticraftWorldProvider {
	@Override
	...
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerCallisto();
	}
	...
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderCallisto(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled());
	}
	...
	public String getSaveFolder() {
		return "DIM" + ConfigManagerCallisto.idDimensionCallisto;
	}
	...
	public CelestialBody getCelestialBody() {
		return CallistoCore.moonCallisto;
	}
